...
const eq5dChoice = (id, label, tops, labels, prompt) => choice(
  id,
  'eq5d',
  label,
  ...
  },
  {
    ...
    questions: [
      eq5dChoice(
        ...
        'Κινητικότητα',
        [120.6, 143.7, 166.8],
        ['Δεν έχω κανένα πρόβλημα στο περπάτημα', 'Έχω μερικά προβλήματα στο περπάτημα', 'Είμαι καθηλωμένος/η στο κρεβάτι'],
        'Επιλέξτε πόσο πρόβλημα έχετε στο περπάτημα σήμερα.',
      ),
      eq5dChoice(
        'eq5d_selfcare',
        'Αυτοεξυπηρέτηση',
        [226.9, 250.0, 273.1],
        ['Δεν έχω κανένα πρόβλημα με την αυτοεξυπηρέτησή μου', 'Έχω μερικά προβλήματα στο να πλένομαι και να ντύνομαι', 'Είμαι ανίκανος/η να πλυθώ ή να ντυθώ'],
        'Επιλέξτε πόσο πρόβλημα έχετε στην αυτοεξυπηρέτησή σας (πλύσιμο, ντύσιμο) σήμερα.',
      ),
      eq5dChoice(
        'eq5d_activities',
        'Συνηθισμένες δραστηριότητες',
        [369.1, 410.2, 451.2],
        ['Κανένα πρόβλημα', 'Μερικά προβλήματα', 'Ανίκανος/η να τις εκτελώ'],
        'Επιλέξτε πόσο πρόβλημα έχετε στις συνηθισμένες δραστηριότητές σας (εργασία, μελέτη, οικιακές δουλειές, ελεύθερος χρόνος) σήμερα.',
      ),
      eq5dChoice(
        'eq5d_pain',
        'Πόνος / Δυσφορία',
        [511.3, 534.4, 557.5],
        ['Καθόλου πόνο ή δυσφορία', 'Μέτριο πόνο ή δυσφορία', 'Υπερβολικό πόνο ή δυσφορία'],
        'Επιλέξτε τον βαθμό πόνου ή δυσφορίας που νιώθετε σήμερα.',
      ),
      eq5dChoice(
        'eq5d_anxiety',
        'Άγχος / Θλίψη',
        [616.9, 640.0, 663.1],
        ['Καθόλου άγχος ή θλίψη', 'Μέτριο άγχος ή θλίψη', 'Υπερβολικό άγχος ή θλίψη'],
        'Επιλέξτε τον βαθμό άγχους ή θλίψης που νιώθετε σήμερα.',
      ),
      text('eq5d_vas', 'eq5d', 'Η υγεία σας σήμερα, από 0 έως 100', [
        ...
        max: 100,
        required: true,
        prompt: 'Σημειώστε πόσο καλή ή κακή είναι η υγεία σας σήμερα. 100 σημαίνει την καλύτερη υγεία που μπορείτε να φανταστείτε, 0 την χειρότερη.',
      }),
    ],
  },
  {
